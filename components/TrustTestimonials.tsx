...
const TESTIMONIAL_ARCHIVES: TestimonialRecord[] = [
  ...
  // ==========================================
  {
    ...
    affiliation: 'Sussex Local Patron',
    location: 'Sussex County, NJ',
    category: 'culinary',
    productId: 'AV-JAR-APOTH',
    harvestNote: 'Local Farm Pickup',
    text: 'Love picking up directly from Sussex County. The wildflower honey has completely spoiled store-bought honey for me.',
    date: 'August 2025',
  },
  {
    id: 'cul-02',
  ...
  },
  {
    ...
    text: 'The best wildflower honey I\'ve had in years. Deep, warm, not overly sweet. We put it on everything.',
    date: 'September 2025',
  },
  {
    id: 'cul-04',
  ...
  // ==========================================
  {
    ...
    affiliation: 'Executive Client Gifting',
    location: 'Princeton, NJ',
    category: 'gifting',
    productId: 'AV-BOX-WALNUT',
    harvestNote: 'Client Appreciation Gift Program',
    text: 'Sent this to six clients; every single one reached out to say thank you. You can’t fake this level of presentation.',
    date: 'October 2025',
  },
  {
    id: 'gift-02',
